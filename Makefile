...
test_mesi: smp_cache
	...
	./smp_cache --cache-size -1 --assoc 8 --block-size 64 --num-proc 4 --protocol 0 --trace ../trace/canneal.04t.debug
...
test_moesi: smp_cache
	...
	./smp_cache --cache-size -1 --assoc 8 --block-size 64 --num-proc 4 --protocol 1 --trace ../trace/canneal.04t.debug
